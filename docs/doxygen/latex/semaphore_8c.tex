\hypertarget{semaphore_8c}{}\section{Riferimenti per il file /mnt/c/\+Users/stefa/\+Desktop/new/system\+\_\+call/src/semaphore.c}
\label{semaphore_8c}\index{/mnt/c/\+Users/stefa/\+Desktop/new/system\+\_\+call/src/semaphore.\+c@{/mnt/c/\+Users/stefa/\+Desktop/new/system\+\_\+call/src/semaphore.\+c}}
...
void \hyperlink{semaphore_8c_a40485eedbf6d56f7fd27bce5a537efbe}{sem\+Wait\+Zero} (int semid, int sem\+\_\+num)
\begin{DoxyCompactList}\small\item\em Attende che il semaforo sem\+\_\+num raggiunga il valore zero. \end{DoxyCompactList}\item 
void \hyperlink{semaphore_8c_a2581efba6a0833e3f289de94c779cc21}{sem\+Wait} (int semid, int sem\+\_\+num)
...
void \hyperlink{semaphore_8c_a7bad0eb0b0c6ac701b59c36b8b7837bf}{sem\+Signal} (int semid, int sem\+\_\+num)
...
void \hyperlink{semaphore_8c_aad78dc4ccefb184a74dd9ef808df8db6}{sem\+Set\+Val} (int semid, int sem\+\_\+num, int val)
\begin{DoxyCompactList}\small\item\em Inizializza il valore del semaforo sem\+\_\+num al valore val. \end{DoxyCompactList}\item 
void \hyperlink{semaphore_8c_a8df9b8ea63eaf93d09f437b356a4a1eb}{sem\+Set\+All} (int semid, short unsigned int values\mbox{[}$\,$\mbox{]})
...
void \hyperlink{semaphore_8c_a530566146b6e3cc8415d8ae4259fd68f}{sem\+Delete} (int semid)
...
struct semid\+\_\+ds \hyperlink{semaphore_8c_a7d80413e893e7d9ae3d153e23c2df2e4}{sem\+Get\+Stats} (int semid)
\begin{DoxyCompactList}\small\item\em Recupera statistiche di un set di semafori. \end{DoxyCompactList}\item 
void \hyperlink{semaphore_8c_a34a010b0a39236a7261d7d5103426491}{sem\+Set\+Perm} (int semid, struct semid\+\_\+ds arg)
...
\begin{center}
\leavevmode
\includegraphics[width=268pt]{semaphore_8c_a530566146b6e3cc8415d8ae4259fd68f_icgraph}
\end{center}
\end{figure}
\mbox{\Hypertarget{semaphore_8c_a7d80413e893e7d9ae3d153e23c2df2e4}\label{semaphore_8c_a7d80413e893e7d9ae3d153e23c2df2e4}} 
\index{semaphore.\+c@{semaphore.\+c}!sem\+Get\+Stats@{sem\+Get\+Stats}}
\index{sem\+Get\+Stats@{sem\+Get\+Stats}!semaphore.\+c@{semaphore.\+c}}
...
\begin{center}
\leavevmode
\includegraphics[width=245pt]{semaphore_8c_a7d80413e893e7d9ae3d153e23c2df2e4_cgraph}
\end{center}
\end{figure}
Questo è il grafo dei chiamanti di questa funzione\+:
\nopagebreak
...
\begin{center}
\leavevmode
\includegraphics[width=278pt]{semaphore_8c_a7d80413e893e7d9ae3d153e23c2df2e4_icgraph}
\end{center}
\end{figure}
...
\begin{center}
\leavevmode
\includegraphics[width=264pt]{semaphore_8c_a8df9b8ea63eaf93d09f437b356a4a1eb_icgraph}
\end{center}
\end{figure}
...
\begin{center}
\leavevmode
\includegraphics[width=277pt]{semaphore_8c_a34a010b0a39236a7261d7d5103426491_icgraph}
\end{center}
\end{figure}
...
\begin{center}
\leavevmode
\includegraphics[width=266pt]{semaphore_8c_aad78dc4ccefb184a74dd9ef808df8db6_icgraph}
\end{center}
\end{figure}
...
\begin{center}
\leavevmode
\includegraphics[width=266pt]{semaphore_8c_a7bad0eb0b0c6ac701b59c36b8b7837bf_icgraph}
\end{center}
\end{figure}
...
\begin{center}
\leavevmode
\includegraphics[width=257pt]{semaphore_8c_a2581efba6a0833e3f289de94c779cc21_icgraph}
\end{center}
\end{figure}
